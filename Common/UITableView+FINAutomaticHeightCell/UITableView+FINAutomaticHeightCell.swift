...
extension UITableView {
    ...
    public func fin_heightForCellWithIdentifier<T: UITableViewCell>(_ identifier: T.Type, indexPath: IndexPath, configuratoin:((_ cell:T) -> Void)?) -> CGFloat {
        ...
        let height = self.fin_heightForCellWithIdentifier(identifierStr, configuration: configuratoin)
    ...
    fileprivate struct AssociatedKey {
        ...
        static var HeightsCacheIdentifier = "me.fin.heightsCacheIdentifer"
