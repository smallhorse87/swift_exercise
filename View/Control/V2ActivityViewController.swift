...
class V2ActivityViewController: UIViewController, UIViewControllerTransitioningDelegate {
    ...
    fileprivate func setupCellView(_ index:Int, currentSection:Int) -> UIView {
        ...
        buttonBackgoundView.snp.makeConstraints { (make) in
...
class V2ActivityTransionPresent:NSObject,UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animate(withDuration: transitionDuration(using: transitionContext), delay: 0, usingSpringWithDamping: 1, initialSpringVelocity: 7, options:
            UIViewAnimationOptions.curveLinear, animations: { () -> Void in
